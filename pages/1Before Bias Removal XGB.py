...
with col1:
    ...
    city = st.selectbox("City", ['BadShire', 'Standhampton', 'Lonton', 'ZeroVille'],help="Indicates the location where the person resides") # All cities in the dataset is included
